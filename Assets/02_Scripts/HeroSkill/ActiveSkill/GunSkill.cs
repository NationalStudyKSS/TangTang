...
/// <summary>
/// 일정 시간마다 가까운 적 캐릭터를 향해 GunBullet을 발사하는 액티브스킬 클래스
/// </summary>
public class GunSkill : FiringActiveSkill
{
    ...
    {
        // 일단 총알을 생성하고
        GameObject go = GameManager.Instance.PoolManager.GetFromPool("Bullet/Gun");
        if (go == null)
        {
        ...
        GunBullet bullet = go.GetComponent<GunBullet>();
        if (bullet == null)
        {
